...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Port-A-Fort", /obj/item/survivalcapsule, 400),
		...
		new /datum/data/mining_equipment("Purple Port-A-Fort", /obj/item/survivalcapsule/luxury, 3000),
		new /datum/data/mining_equipment("Gold Port-A-Fort", /obj/item/survivalcapsule/luxuryelite, 10000),
